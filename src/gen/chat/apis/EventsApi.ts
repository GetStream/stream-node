...
export class EventsApi extends runtime.BaseAPI {
   ...
   */
  async sendEventRaw(
    requestParameters: SendEventOperationRequest,
    ...
    if (
      requestParameters.sendEventRequest === null ||
      requestParameters.sendEventRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'sendEventRequest',
        'Required parameter requestParameters.sendEventRequest was null or undefined when calling sendEvent.',
      );
    }
   ...
   * Send user event
   */
  async sendUserCustomEventRaw(
    requestParameters: SendUserCustomEventOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'userId',
        'Required parameter requestParameters.userId was null or undefined when calling sendUserCustomEvent.',
      );
    }

    if (
      requestParameters.sendUserCustomEventRequest === null ||
      requestParameters.sendUserCustomEventRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'sendUserCustomEventRequest',
        'Required parameter requestParameters.sendUserCustomEventRequest was null or undefined when calling sendUserCustomEvent.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/users/{user_id}/event`.replace(
          `{${'user_id'}}`,
  ...
  async sendUserCustomEvent(
    ...
    const response = await this.sendUserCustomEventRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
