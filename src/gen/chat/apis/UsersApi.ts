...
export class UsersApi extends runtime.BaseAPI {
   ...
   */
  async banRaw(
    requestParameters: BanOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Response>> {
    if (
      requestParameters.banRequest === null ||
      requestParameters.banRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'banRequest',
        'Required parameter requestParameters.banRequest was null or undefined when calling ban.',
      );
    }
   ...
   */
  async connectRaw(
    requestParameters: ConnectOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  async createGuestRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GuestResponse>> {
    if (
      requestParameters.guestRequest === null ||
      requestParameters.guestRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'guestRequest',
        'Required parameter requestParameters.guestRequest was null or undefined when calling createGuest.',
      );
    }
  ...
  async deactivateUserRaw(
    requestParameters: DeactivateUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeactivateUserResponse>> {
    if (
    ...
    if (
      requestParameters.deactivateUserRequest === null ||
      requestParameters.deactivateUserRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'deactivateUserRequest',
        'Required parameter requestParameters.deactivateUserRequest was null or undefined when calling deactivateUser.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/users/{user_id}/deactivate`.replace(
          `{${'user_id'}}`,
  ...
  async deactivateUser(
    ...
    const response = await this.deactivateUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async deactivateUsersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeactivateUsersResponse>> {
    if (
  ...
  async deactivateUsers(
    requestParameters: DeactivateUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<DeactivateUsersResponse> {
    const response = await this.deactivateUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  async deleteUserRaw(
    ...
    if (requestParameters.markMessagesDeleted !== undefined) {
      queryParameters['mark_messages_deleted'] =
        requestParameters.markMessagesDeleted;
    }
    ...
    if (requestParameters.deleteConversationChannels !== undefined) {
      queryParameters['delete_conversation_channels'] =
        requestParameters.deleteConversationChannels;
    }
  ...
  async deleteUsersRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeleteUsersResponse>> {
    if (
  ...
  async deleteUsers(
    ...
    const response = await this.deleteUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async exportUserRaw(
    requestParameters: ExportUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ExportUserResponse>> {
    if (
      requestParameters.userId === null ||
      requestParameters.userId === undefined
    ) {
      throw new runtime.RequiredError(
        'userId',
        'Required parameter requestParameters.userId was null or undefined when calling exportUser.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/users/{user_id}/export`.replace(
          `{${'user_id'}}`,
          encodeURIComponent(String(requestParameters.userId)),
        ),
        method: 'GET',
  ...
  async exportUsersRaw(
    requestParameters: ExportUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ExportUsersResponse>> {
    if (
      requestParameters.exportUsersRequest === null ||
      requestParameters.exportUsersRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'exportUsersRequest',
        'Required parameter requestParameters.exportUsersRequest was null or undefined when calling exportUsers.',
      );
    }
  ...
  async exportUsers(
    ...
    const response = await this.exportUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async longPollRaw(
    requestParameters: LongPollRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    const queryParameters: any = {};
   ...
   */
  async muteUserRaw(
    requestParameters: MuteUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<MuteUserResponse>> {
    if (
      requestParameters.muteUserRequest === null ||
      requestParameters.muteUserRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'muteUserRequest',
        'Required parameter requestParameters.muteUserRequest was null or undefined when calling muteUser.',
      );
    }
   ...
   * Query Banned Users
   */
  async queryBannedUsersRaw(
    requestParameters: QueryBannedUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<QueryBannedUsersResponse>> {
    const queryParameters: any = {};
  ...
  async queryBannedUsers(
    ...
    const response = await this.queryBannedUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async queryUsersRaw(
    requestParameters: QueryUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * Reactivate user
   */
  async reactivateUserRaw(
    requestParameters: ReactivateUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ReactivateUserResponse>> {
    if (
      requestParameters.userId === null ||
      requestParameters.userId === undefined
    ) {
    ...
    if (
      requestParameters.reactivateUserRequest === null ||
      requestParameters.reactivateUserRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'reactivateUserRequest',
    ...
    const response = await this.request(
      {
        path: `/users/{user_id}/reactivate`.replace(
          `{${'user_id'}}`,
          encodeURIComponent(String(requestParameters.userId)),
        ),
        method: 'POST',
  ...
  async reactivateUser(
    ...
    const response = await this.reactivateUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Reactivate users
   */
  async reactivateUsersRaw(
    requestParameters: ReactivateUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ReactivateUsersResponse>> {
    if (
      requestParameters.reactivateUsersRequest === null ||
      requestParameters.reactivateUsersRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'reactivateUsersRequest',
        'Required parameter requestParameters.reactivateUsersRequest was null or undefined when calling reactivateUsers.',
      );
    }
  ...
  async reactivateUsers(
    requestParameters: ReactivateUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ReactivateUsersResponse> {
    const response = await this.reactivateUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   * Restore users
   */
  async restoreUsersRaw(
    requestParameters: RestoreUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Response>> {
    if (
      requestParameters.restoreUsersRequest === null ||
      requestParameters.restoreUsersRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'restoreUsersRequest',
        'Required parameter requestParameters.restoreUsersRequest was null or undefined when calling restoreUsers.',
      );
    }
  ...
  async restoreUsers(
    ...
    const response = await this.restoreUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async unbanRaw(
    requestParameters: UnbanRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Response>> {
    const queryParameters: any = {};
   ...
   */
  async unmuteUserRaw(
    requestParameters: UnmuteUserOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UnmuteResponse>> {
    if (
      requestParameters.unmuteUserRequest === null ||
      requestParameters.unmuteUserRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'unmuteUserRequest',
        'Required parameter requestParameters.unmuteUserRequest was null or undefined when calling unmuteUser.',
      );
    }
   ...
   * Upsert users
   */
  async updateUsersRaw(
    requestParameters: UpdateUsersOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UpdateUsersResponse>> {
    if (
      requestParameters.updateUsersRequest === null ||
      requestParameters.updateUsersRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'updateUsersRequest',
        'Required parameter requestParameters.updateUsersRequest was null or undefined when calling updateUsers.',
      );
    }
  ...
  async updateUsers(
    ...
    const response = await this.updateUsersRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
   ...
   */
  async updateUsersPartialRaw(
    requestParameters: UpdateUsersPartialRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UpdateUsersResponse>> {
    if (
      requestParameters.updateUserPartialRequest === null ||
      requestParameters.updateUserPartialRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'updateUserPartialRequest',
        'Required parameter requestParameters.updateUserPartialRequest was null or undefined when calling updateUsersPartial.',
      );
    }
  ...
  async updateUsersPartial(
    ...
    const response = await this.updateUsersPartialRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
