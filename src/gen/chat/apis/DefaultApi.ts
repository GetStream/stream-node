...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Get Call Token
     */
    async getCallToken0Raw(requestParameters: GetCallToken0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCallTokenResponse>> {
        if (requestParameters.callId === null || requestParameters.callId === undefined) {
            throw new runtime.RequiredError('callId','Required parameter requestParameters.callId was null or undefined when calling getCallToken0.');
        }

        if (requestParameters.getCallTokenRequest === null || requestParameters.getCallTokenRequest === undefined) {
            throw new runtime.RequiredError('getCallTokenRequest','Required parameter requestParameters.getCallTokenRequest was null or undefined when calling getCallToken0.');
        }
     ...
     * Get Call Token
     */
    async getCallToken0(requestParameters: GetCallToken0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCallTokenResponse> {
        const response = await this.getCallToken0Raw(requestParameters, initOverrides);
        return await response.value();
    }
