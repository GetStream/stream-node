...
export interface GetCallToken1Request {
    getCallTokenRequest: GetCallTokenRequest | null;
}

export interface GetCallTokenCallId0Request {
    callId: string;
    getCallTokenRequest: GetCallTokenRequest | null;
}
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Get Call Token ()
     */
    async getCallToken1Raw(requestParameters: GetCallToken1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCallTokenResponse>> {
        if (requestParameters.getCallTokenRequest === null || requestParameters.getCallTokenRequest === undefined) {
            throw new runtime.RequiredError('getCallTokenRequest','Required parameter requestParameters.getCallTokenRequest was null or undefined when calling getCallToken1.');
        }
     ...
     * Get Call Token ()
     */
    async getCallToken1(requestParameters: GetCallToken1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCallTokenResponse> {
        const response = await this.getCallToken1Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getCallTokenCallId0Raw(requestParameters: GetCallTokenCallId0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCallTokenResponse>> {
        if (requestParameters.callId === null || requestParameters.callId === undefined) {
            throw new runtime.RequiredError('callId','Required parameter requestParameters.callId was null or undefined when calling getCallTokenCallId0.');
        }

        if (requestParameters.getCallTokenRequest === null || requestParameters.getCallTokenRequest === undefined) {
            throw new runtime.RequiredError('getCallTokenRequest','Required parameter requestParameters.getCallTokenRequest was null or undefined when calling getCallTokenCallId0.');
        }
     ...
     * Get Call Token (call_id)
     */
    async getCallTokenCallId0(requestParameters: GetCallTokenCallId0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCallTokenResponse> {
        const response = await this.getCallTokenCallId0Raw(requestParameters, initOverrides);
        return await response.value();
    }
