...
export interface GetOrCreateChannel0Request {
    type: string;
    id: string;
...
export interface GetOrCreateChannel1Request {
    type: string;
    channelGetOrCreateRequest: ChannelGetOrCreateRequest | null;
    clientId?: string;
    connectionId?: string;
...
export class ChannelsApi extends runtime.BaseAPI {
     ...
     */
    async getOrCreateChannel0Raw(requestParameters: GetOrCreateChannel0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ChannelStateResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling getOrCreateChannel0.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getOrCreateChannel0.');
        }

        if (requestParameters.channelGetOrCreateRequest === null || requestParameters.channelGetOrCreateRequest === undefined) {
            throw new runtime.RequiredError('channelGetOrCreateRequest','Required parameter requestParameters.channelGetOrCreateRequest was null or undefined when calling getOrCreateChannel0.');
        }
     ...
     * Get or create channel
     */
    async getOrCreateChannel0(requestParameters: GetOrCreateChannel0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ChannelStateResponse> {
        const response = await this.getOrCreateChannel0Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get or create channel
     */
    async getOrCreateChannel1Raw(requestParameters: GetOrCreateChannel1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ChannelStateResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling getOrCreateChannel1.');
        }

        if (requestParameters.channelGetOrCreateRequest === null || requestParameters.channelGetOrCreateRequest === undefined) {
            throw new runtime.RequiredError('channelGetOrCreateRequest','Required parameter requestParameters.channelGetOrCreateRequest was null or undefined when calling getOrCreateChannel1.');
        }
     ...
     * Get or create channel
     */
    async getOrCreateChannel1(requestParameters: GetOrCreateChannel1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ChannelStateResponse> {
        const response = await this.getOrCreateChannel1Raw(requestParameters, initOverrides);
        return await response.value();
    }
