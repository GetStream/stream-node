...
export interface GetOrCreateChannelType1Request {
    type: string;
...
export interface GetOrCreateChannelTypeId0Request {
    type: string;
    id: string;
    channelGetOrCreateRequest: ChannelGetOrCreateRequest | null;
    clientId?: string;
...
export class ChannelsApi extends runtime.BaseAPI {
     ...
     */
    async getOrCreateChannelType1Raw(requestParameters: GetOrCreateChannelType1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ChannelStateResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling getOrCreateChannelType1.');
        }

        if (requestParameters.channelGetOrCreateRequest === null || requestParameters.channelGetOrCreateRequest === undefined) {
            throw new runtime.RequiredError('channelGetOrCreateRequest','Required parameter requestParameters.channelGetOrCreateRequest was null or undefined when calling getOrCreateChannelType1.');
        }
     ...
     * Get or create channel (type)
     */
    async getOrCreateChannelType1(requestParameters: GetOrCreateChannelType1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ChannelStateResponse> {
        const response = await this.getOrCreateChannelType1Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getOrCreateChannelTypeId0Raw(requestParameters: GetOrCreateChannelTypeId0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ChannelStateResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling getOrCreateChannelTypeId0.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getOrCreateChannelTypeId0.');
        }

        if (requestParameters.channelGetOrCreateRequest === null || requestParameters.channelGetOrCreateRequest === undefined) {
            throw new runtime.RequiredError('channelGetOrCreateRequest','Required parameter requestParameters.channelGetOrCreateRequest was null or undefined when calling getOrCreateChannelTypeId0.');
        }
     ...
     * Get or create channel (type, id)
     */
    async getOrCreateChannelTypeId0(requestParameters: GetOrCreateChannelTypeId0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ChannelStateResponse> {
        const response = await this.getOrCreateChannelTypeId0Raw(requestParameters, initOverrides);
        return await response.value();
    }
