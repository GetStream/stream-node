...
export class PermissionsV2Api extends runtime.BaseAPI {
  ...
  ): Promise<runtime.ApiResponse<CreateRoleResponse>> {
    if (
      requestParameters.createRoleRequest === null ||
      requestParameters.createRoleRequest === undefined
    ) {
      throw new runtime.RequiredError(
        'createRoleRequest',
        'Required parameter requestParameters.createRoleRequest was null or undefined when calling createRole.',
      );
    }
  ...
  async deleteRoleRaw(
    ...
    if (
      ...
      throw new runtime.RequiredError(
        'name',
        'Required parameter requestParameters.name was null or undefined when calling deleteRole.',
      );
    }
  ...
  async getPermissionRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetCustomPermissionResponse>> {
  ...
  async getPermission(
    requestParameters: GetPermissionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetCustomPermissionResponse> {
  ...
  async listPermissionsRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListPermissionsResponse>> {
    const queryParameters: any = {};
  ...
  async listRolesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ListRolesResponse>> {
    const queryParameters: any = {};
