...
export interface ListRecordings0Request {
    type: string;
    id: string;
}

export interface ListRecordings1Request {
    type: string;
    id: string;
    session: string;
}
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * List recordings
     */
    async listRecordings0Raw(requestParameters: ListRecordings0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VideoListRecordingsResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling listRecordings0.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling listRecordings0.');
        }
     ...
     * List recordings
     */
    async listRecordings0(requestParameters: ListRecordings0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VideoListRecordingsResponse> {
        const response = await this.listRecordings0Raw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * List recordings
     */
    async listRecordings1Raw(requestParameters: ListRecordings1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VideoListRecordingsResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling listRecordings1.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling listRecordings1.');
        }

        if (requestParameters.session === null || requestParameters.session === undefined) {
            throw new runtime.RequiredError('session','Required parameter requestParameters.session was null or undefined when calling listRecordings1.');
        }
     ...
     * List recordings
     */
    async listRecordings1(requestParameters: ListRecordings1Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VideoListRecordingsResponse> {
        const response = await this.listRecordings1Raw(requestParameters, initOverrides);
        return await response.value();
    }
