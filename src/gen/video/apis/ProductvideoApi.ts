...
export interface StartRTMPBroadcastRequest {
    type: string;
    id: string;
    videoStartRTMPBroadcastsRequest: VideoStartRTMPBroadcastsRequest | null;
}
...
export interface StopRTMPBroadcastRequest {
    type: string;
    id: string;
    name: string;
    body: object | null;
...
export class ProductvideoApi extends runtime.BaseAPI {
     ...
     */
    async startRTMPBroadcastRaw(requestParameters: StartRTMPBroadcastRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VideoStartRTMPBroadcastsResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling startRTMPBroadcast.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling startRTMPBroadcast.');
        }

        if (requestParameters.videoStartRTMPBroadcastsRequest === null || requestParameters.videoStartRTMPBroadcastsRequest === undefined) {
            throw new runtime.RequiredError('videoStartRTMPBroadcastsRequest','Required parameter requestParameters.videoStartRTMPBroadcastsRequest was null or undefined when calling startRTMPBroadcast.');
        }
        ...
        const response = await this.request({
            path: `/video/call/{type}/{id}/rtmp_broadcasts`.replace(`{${"type"}}`, encodeURIComponent(String(requestParameters.type))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.videoStartRTMPBroadcastsRequest,
        }, initOverrides);
     ...
     * Start RTMP broadcasts
     */
    async startRTMPBroadcast(requestParameters: StartRTMPBroadcastRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VideoStartRTMPBroadcastsResponse> {
        const response = await this.startRTMPBroadcastRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async stopAllRTMPBroadcastsRaw(requestParameters: StopAllRTMPBroadcastsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VideoStopAllRTMPBroadcastsResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling stopAllRTMPBroadcasts.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling stopAllRTMPBroadcasts.');
        }
        ...
        const response = await this.request({
            path: `/video/call/{type}/{id}/rtmp_broadcasts/stop`.replace(`{${"type"}}`, encodeURIComponent(String(requestParameters.type))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Stop all RTMP broadcasts for a call
     */
    async stopAllRTMPBroadcasts(requestParameters: StopAllRTMPBroadcastsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VideoStopAllRTMPBroadcastsResponse> {
        const response = await this.stopAllRTMPBroadcastsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async stopRTMPBroadcastRaw(requestParameters: StopRTMPBroadcastRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<VideoStopRTMPBroadcastsResponse>> {
        if (requestParameters.type === null || requestParameters.type === undefined) {
            throw new runtime.RequiredError('type','Required parameter requestParameters.type was null or undefined when calling stopRTMPBroadcast.');
        }

        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling stopRTMPBroadcast.');
        }

        if (requestParameters.name === null || requestParameters.name === undefined) {
            throw new runtime.RequiredError('name','Required parameter requestParameters.name was null or undefined when calling stopRTMPBroadcast.');
        }

        if (requestParameters.body === null || requestParameters.body === undefined) {
            throw new runtime.RequiredError('body','Required parameter requestParameters.body was null or undefined when calling stopRTMPBroadcast.');
        }
        ...
        const response = await this.request({
            path: `/video/call/{type}/{id}/rtmp_broadcasts/{name}/stop`.replace(`{${"type"}}`, encodeURIComponent(String(requestParameters.type))).replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))).replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Stop RTMP broadcasts
     */
    async stopRTMPBroadcast(requestParameters: StopRTMPBroadcastRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<VideoStopRTMPBroadcastsResponse> {
        const response = await this.stopRTMPBroadcastRaw(requestParameters, initOverrides);
        return await response.value();
    }
