...
export type VideoAudioSettingsDefaultDeviceEnum =
  (typeof VideoAudioSettingsDefaultDeviceEnum)[keyof typeof VideoAudioSettingsDefaultDeviceEnum];
...
export type VideoAudioSettingsRequestDefaultDeviceEnum =
  (typeof VideoAudioSettingsRequestDefaultDeviceEnum)[keyof typeof VideoAudioSettingsRequestDefaultDeviceEnum];
...
export type VideoCreateDeviceRequestPushProviderEnum =
  (typeof VideoCreateDeviceRequestPushProviderEnum)[keyof typeof VideoCreateDeviceRequestPushProviderEnum];
...
export type VideoLayoutSettingsNameEnum =
  (typeof VideoLayoutSettingsNameEnum)[keyof typeof VideoLayoutSettingsNameEnum];
...
export type VideoLayoutSettingsRequestNameEnum =
  (typeof VideoLayoutSettingsRequestNameEnum)[keyof typeof VideoLayoutSettingsRequestNameEnum];
...
export type VideoOwnCapability =
  (typeof VideoOwnCapability)[keyof typeof VideoOwnCapability];
...
export type VideoRecordSettingsRequestModeEnum =
  (typeof VideoRecordSettingsRequestModeEnum)[keyof typeof VideoRecordSettingsRequestModeEnum];
...
export type VideoRecordSettingsRequestQualityEnum =
  (typeof VideoRecordSettingsRequestQualityEnum)[keyof typeof VideoRecordSettingsRequestQualityEnum];
...
export type VideoTranscriptionSettingsModeEnum =
  (typeof VideoTranscriptionSettingsModeEnum)[keyof typeof VideoTranscriptionSettingsModeEnum];
...
export type VideoTranscriptionSettingsRequestModeEnum =
  (typeof VideoTranscriptionSettingsRequestModeEnum)[keyof typeof VideoTranscriptionSettingsRequestModeEnum];
...
export type VideoVideoEvent =
  | ({ type: 'call.accepted' } & VideoCallAcceptedEvent)
  | ({ type: 'call.blocked_user' } & VideoBlockedUserEvent)
  | ({ type: 'call.created' } & VideoCallCreatedEvent)
  | ({ type: 'call.ended' } & VideoCallEndedEvent)
  | ({
  ...
  | ({ type: 'call.live_started' } & VideoCallLiveStartedEvent)
  | ({ type: 'call.member_added' } & VideoCallMemberAddedEvent)
  | ({ type: 'call.member_removed' } & VideoCallMemberRemovedEvent)
  | ({ type: 'call.member_updated' } & VideoCallMemberUpdatedEvent)
  | ({
      type: 'call.member_updated_permission';
    } & VideoCallMemberUpdatedPermissionEvent)
  | ({ type: 'call.notification' } & VideoCallNotificationEvent)
  | ({ type: 'call.permission_request' } & VideoPermissionRequestEvent)
  | ({ type: 'call.permissions_updated' } & VideoUpdatedCallPermissionsEvent)
  | ({ type: 'call.reaction_new' } & VideoCallReactionEvent)
  | ({ type: 'call.recording_failed' } & VideoCallRecordingFailedEvent)
  | ({ type: 'call.recording_ready' } & VideoCallRecordingReadyEvent)
  | ({ type: 'call.recording_started' } & VideoCallRecordingStartedEvent)
  | ({ type: 'call.recording_stopped' } & VideoCallRecordingStoppedEvent)
  | ({ type: 'call.rejected' } & VideoCallRejectedEvent)
  | ({ type: 'call.ring' } & VideoCallRingEvent)
  | ({ type: 'call.session_ended' } & VideoCallSessionEndedEvent)
  | ({
  ...
  | ({ type: 'call.session_started' } & VideoCallSessionStartedEvent)
  | ({ type: 'call.unblocked_user' } & VideoUnblockedUserEvent)
  | ({ type: 'call.updated' } & VideoCallUpdatedEvent)
  | ({ type: 'call.user_muted' } & VideoCallUserMuted)
  | ({ type: 'connection.error' } & VideoConnectionErrorEvent)
  | ({ type: 'connection.ok' } & VideoConnectedEvent)
  | ({ type: 'custom' } & VideoCustomVideoEvent)
  | ({ type: 'health.check' } & VideoHealthCheckEvent);
/**
 *
 * @export
...
export type VideoVideoSettingsCameraFacingEnum =
  (typeof VideoVideoSettingsCameraFacingEnum)[keyof typeof VideoVideoSettingsCameraFacingEnum];
...
export type VideoVideoSettingsRequestCameraFacingEnum =
  (typeof VideoVideoSettingsRequestCameraFacingEnum)[keyof typeof VideoVideoSettingsRequestCameraFacingEnum];
